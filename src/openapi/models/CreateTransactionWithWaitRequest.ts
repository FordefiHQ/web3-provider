...
import type { CreateTronMessageWithWaitRequest } from './CreateTronMessageWithWaitRequest';
import {
    CreateTronMessageWithWaitRequestToJSON,
} from './CreateTronMessageWithWaitRequest';
...
function CreateTransactionWithWaitRequestToJSONTyped(value?: CreateTransactionWithWaitRequest | null, _ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
        ...
        case 'tron_message':
            return Object.assign({}, CreateTronMessageWithWaitRequestToJSON(value), { type: 'tron_message' } as const);
