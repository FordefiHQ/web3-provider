...
import {
    ...
    TronVaultEnergyAndBandwidthDataFromJSONTyped,
    TronVaultEnergyAndBandwidthDataToJSON,
    TronVaultEnergyAndBandwidthDataToJSONTyped,
 ...
 * @export
 */
export const TronVaultTypeEnum = {
    tron: 'tron'
} as const;
export type TronVaultTypeEnum = typeof TronVaultTypeEnum[keyof typeof TronVaultTypeEnum];


/**
 * Check if a given object implements the TronVault interface.
 */
export function instanceOfTronVault(value: object): value is TronVault {
    ...
    if (!('energyAndBandwidthDataMap' in value) || value['energyAndBandwidthDataMap'] === undefined) return false;
    return true;
}

export function TronVaultFromJSON(json: any): TronVault {
    return TronVaultFromJSONTyped(json, false);
}

export function TronVaultFromJSONTyped(json: any, ignoreDiscriminator: boolean): TronVault {
    if (json == null) {
        return json;
    }
    return {
...
export function TronVaultToJSON(json: any): TronVault {
    return TronVaultToJSONTyped(json, false);
}

export function TronVaultToJSONTyped(value?: TronVault | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'energy_and_bandwidth_data_map': (mapValues(value['energyAndBandwidthDataMap'], TronVaultEnergyAndBandwidthDataToJSON)),
    };
}
