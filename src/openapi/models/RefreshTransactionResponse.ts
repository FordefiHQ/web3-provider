...
export function RefreshTransactionResponseToJSON(json: any): any {
    return RefreshTransactionResponseToJSONTyped(json, false);
}

export function RefreshTransactionResponseToJSONTyped(value?: RefreshTransactionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
        ...
        default:
            throw new Error(`No variant of RefreshTransactionResponse exists with 'type=${value['type']}'`);
    }
