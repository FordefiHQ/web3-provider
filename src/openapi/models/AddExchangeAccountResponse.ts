...
/**
 * @type AddExchangeAccountResponse
 * 
 * @export
 */
export type AddExchangeAccountResponse = { type: 'aptos' } & AptosVault | { type: 'black_box' } & BlackBoxVault | { type: 'cosmos' } & CosmosVault | { type: 'evm' } & EvmVault | { type: 'exchange' } & ExchangeVault | { type: 'solana' } & SolanaVault | { type: 'sui' } & SuiVault | { type: 'utxo' } & UtxoVault;

export function AddExchangeAccountResponseFromJSON(json: any): AddExchangeAccountResponse {
    return AddExchangeAccountResponseFromJSONTyped(json, false);
}

export function AddExchangeAccountResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddExchangeAccountResponse {
    ...
    switch (json['type']) {
        ...
        default:
            throw new Error(`No variant of AddExchangeAccountResponse exists with 'type=${json['type']}'`);
    }
}

export function AddExchangeAccountResponseToJSON(value?: AddExchangeAccountResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    switch (value['type']) {
        ...
        default:
            throw new Error(`No variant of AddExchangeAccountResponse exists with 'type=${value['type']}'`);
    }
