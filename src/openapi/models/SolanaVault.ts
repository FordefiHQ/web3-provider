 ...
 */
export function instanceOfSolanaVault(value: object): value is SolanaVault {
...
export function SolanaVaultToJSON(json: any): SolanaVault {
    return SolanaVaultToJSONTyped(json, false);
}

export function SolanaVaultToJSONTyped(value?: SolanaVault | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
