...
function CosmosMessageDataFromJSONTyped(json: any, _ignoreDiscriminator: boolean): CosmosMessageData {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
...
function CosmosMessageDataToJSONTyped(value?: CosmosMessageData | null, _ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
