...
import {
    instanceOfStacksNativeAssetIdentifierRequest,
    StacksNativeAssetIdentifierRequestFromJSON,
...
import {
    instanceOfStacksSip10AssetIdentifierRequest,
    StacksSip10AssetIdentifierRequestFromJSON,
...
export function StacksAssetIdentifierDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StacksAssetIdentifierDetails {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
...
export function StacksAssetIdentifierDetailsToJSONTyped(value?: StacksAssetIdentifierDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
