...
export interface PersonExt {
     ...
     * @memberof PersonExt
     */
    userType: PersonExtUserTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof PersonExt
 ...
 * @export
 */
export const PersonExtUserTypeEnum = {
    person: 'person'
} as const;
export type PersonExtUserTypeEnum = typeof PersonExtUserTypeEnum[keyof typeof PersonExtUserTypeEnum];
...
export function PersonExtFromJSON(json: any): PersonExt {
    return PersonExtFromJSONTyped(json, false);
}
