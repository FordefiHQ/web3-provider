...
function EvmAssetIdentifierDetailsFromJSONTyped(json: any, _ignoreDiscriminator: boolean): EvmAssetIdentifierDetails {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
...
function EvmAssetIdentifierDetailsToJSONTyped(value?: EvmAssetIdentifierDetails | null, _ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
