...
export function UpdateTransactionForSigningResponseToJSON(json: any): any {
    return UpdateTransactionForSigningResponseToJSONTyped(json, false);
}

export function UpdateTransactionForSigningResponseToJSONTyped(value?: UpdateTransactionForSigningResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
