 ...
 * @export
 */
export const StacksVaultTypeEnum = {
    stacks: 'stacks'
} as const;
export type StacksVaultTypeEnum = typeof StacksVaultTypeEnum[keyof typeof StacksVaultTypeEnum];


/**
 * Check if a given object implements the StacksVault interface.
 */
export function instanceOfStacksVault(value: object): value is StacksVault {
...
export function StacksVaultFromJSON(json: any): StacksVault {
    return StacksVaultFromJSONTyped(json, false);
}

export function StacksVaultFromJSONTyped(json: any, ignoreDiscriminator: boolean): StacksVault {
    if (json == null) {
        return json;
    }
    return {
...
export function StacksVaultToJSON(json: any): StacksVault {
    return StacksVaultToJSONTyped(json, false);
}

export function StacksVaultToJSONTyped(value?: StacksVault | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
