 ...
 * @export
 */
export type GetUserResponse = { userType: 'api_signer' } & ApiSigner | { userType: 'api_user' } & ApiUser | { userType: 'person' } & Person | { userType: 'system' } & SystemUser;
...
export function GetUserResponseToJSON(json: any): any {
