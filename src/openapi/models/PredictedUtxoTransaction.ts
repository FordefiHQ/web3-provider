...
type PredictedUtxoTransactionTypeEnum = typeof PredictedUtxoTransactionTypeEnum[keyof typeof PredictedUtxoTransactionTypeEnum];

export function PredictedUtxoTransactionFromJSONTyped(json: any, _ignoreDiscriminator: boolean): PredictedUtxoTransaction {
    if (json == null) {
        return json;
    }
    return {
