 ...
 */
export function instanceOfDefinedPreconditionErrorTestWebhookErrorType(value: object): boolean {
    let isInstance = true;
...
export function DefinedPreconditionErrorTestWebhookErrorTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefinedPreconditionErrorTestWebhookErrorType {
    ...
    return {
        ...
        'errorType': !exists(json, 'error_type') ? undefined : TestWebhookErrorTypeFromJSON(json['error_type']),
    };
}

export function DefinedPreconditionErrorTestWebhookErrorTypeToJSON(value?: DefinedPreconditionErrorTestWebhookErrorType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
