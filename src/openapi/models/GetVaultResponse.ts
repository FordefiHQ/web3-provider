...
export function GetVaultResponseToJSON(json: any): any {
    return GetVaultResponseToJSONTyped(json, false);
}

export function GetVaultResponseToJSONTyped(value?: GetVaultResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
