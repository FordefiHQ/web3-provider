...
/**
 * @type CreateExchangeVaultResponse
 * 
 * @export
 */
export type CreateExchangeVaultResponse = { type: 'aptos' } & AptosVault | { type: 'black_box' } & BlackBoxVault | { type: 'cosmos' } & CosmosVault | { type: 'evm' } & EvmVault | { type: 'exchange' } & ExchangeVault | { type: 'solana' } & SolanaVault | { type: 'stacks' } & StacksVault | { type: 'starknet' } & StarknetVault | { type: 'sui' } & SuiVault | { type: 'ton' } & TonVault | { type: 'tron' } & TronVault | { type: 'utxo' } & UtxoVault;

export function CreateExchangeVaultResponseFromJSON(json: any): CreateExchangeVaultResponse {
    return CreateExchangeVaultResponseFromJSONTyped(json, false);
}

export function CreateExchangeVaultResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateExchangeVaultResponse {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
        ...
        default:
            throw new Error(`No variant of CreateExchangeVaultResponse exists with 'type=${json['type']}'`);
    }
}

export function CreateExchangeVaultResponseToJSON(json: any): any {
    return CreateExchangeVaultResponseToJSONTyped(json, false);
}

export function CreateExchangeVaultResponseToJSONTyped(value?: CreateExchangeVaultResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
        ...
        default:
            throw new Error(`No variant of CreateExchangeVaultResponse exists with 'type=${value['type']}'`);
    }
