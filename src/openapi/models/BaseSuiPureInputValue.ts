...
function BaseSuiPureInputValueFromJSONTyped(json: any, _ignoreDiscriminator: boolean): BaseSuiPureInputValue {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
...
function BaseSuiPureInputValueToJSONTyped(value?: BaseSuiPureInputValue | null, _ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
