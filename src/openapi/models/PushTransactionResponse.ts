...
export function PushTransactionResponseToJSON(json: any): any {
    return PushTransactionResponseToJSONTyped(json, false);
}

export function PushTransactionResponseToJSONTyped(value?: PushTransactionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
        ...
        default:
            throw new Error(`No variant of PushTransactionResponse exists with 'type=${value['type']}'`);
    }
