...
type CreateSuiMessageWithWaitRequestTypeEnum = typeof CreateSuiMessageWithWaitRequestTypeEnum[keyof typeof CreateSuiMessageWithWaitRequestTypeEnum];
...
function CreateSuiMessageWithWaitRequestToJSONTyped(value?: CreateSuiMessageWithWaitRequest | null, _ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
